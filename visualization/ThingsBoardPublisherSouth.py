...
ACCESS_TOKEN = 'SouthDeviceAccessToken'		# Access Token for south device
...
try:
    while True:
		# opening south Moisture file
		moistureFile = open('southMoisture.txt', 'r')
		# opening south temperature and humidity file		
		temperatureAndHumidityFile = open('southTemperatureAndHumidity.txt', 'r') 
